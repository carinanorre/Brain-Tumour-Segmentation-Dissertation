...
from tensorflow.keras.layers import MaxPooling2D, Conv2D, BatchNormalization, concatenate, Input, Activation, \
    Conv2DTranspose
from tensorflow.keras.optimizers import Adam
from Dice_functions import *

# The Individual-UNetModel-HGG file contains the U-Net model explored individually for this project. This file evaluates
# the HGG dataset. The U-Net model below contains all the additional 2D convolutional layers added onto the base,
...
modelUNet.save('./Saved_models/individual-model-HGG.h5', overwrite=True)
